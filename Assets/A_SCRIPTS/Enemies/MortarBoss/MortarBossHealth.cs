...
public class MortarBossHealth : MonoBehaviour, IDamageable
{
    ...
    // eventos compatibles con UIHealthBarDashBoss
    public event Action<float> OnDamage;        // pasa HP actual
    public event Action<float> OnHealthChanged; // pasa 0-1 normalizado
